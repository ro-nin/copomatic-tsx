...
const Landing = (props: Props) => {
    return <div className='bgLandingGradient flex flex-col min-h-screen justify-center items-center'>
        ...
        <p className='mt-8'>All text content and artworks shown in this site are registered property of studio ZAUM, I do not own any rights.</p>
        <a href="/#stats" className=' mt-6 scroll-smooth text-2xl rounded my-2 text-white bg-black p-4 uppercase hover:bg-opacity-80'> Start</a>
